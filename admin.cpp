...
int customerExists(string id){
    fstream fcustomer;
                ...
                while(!fcustomer.eof()){
                    ...
                    //cout<<a.id<<" id "<<tempid<<endl;
                    if(strcmp(c.id,id.c_str())==0){fcustomer.close();return 1;}
...
void addlboy(){
    is_firsttime_launch_lboy();
                ...
                while(!fnewlboy.eof()){
                    ...
                    if(strcmp(newlboy.id,tmpid.c_str())==0){cout<<"Laundry Boy already exists... Try another Id!!"<<endl;
                    break;}
...
void editSingleItem(scheduleitem listOfItems[],int number){
    ...
    t:
    clrscr();
    gotoxy(30,0);cout<<"Current Item Looks Like"<<endl;
...
void editScheduleItem(){
    ...
    switch(inpEdit){
       ...
       // listOfItems=viewSchedule_admin(queryDayOfWeek);
        ...
        editSingleItem(listOfItems,editNo);
        ent break;}
        case 4:{queryDayOfWeek="Thursday";
        {
            int items=0;
                fstream fViewScheduleA;
                scheduleitem viewItemA;
        ...
        // listOfItems=viewSchedule_admin(queryDayOfWeek);
        cout<<"enter the entry you want to edit: ";
        editNo=input();editSingleItem(listOfItems,editNo);
         ent break;}
        case 6:{
...
void loginadmin(){
    fstream fadmin;
                    ...
                    if(strcmp(a.password,temppwd.c_str())==0){
                        cout<<"\nPassword match"<<endl<<"Welcome "<<a.username<<"!!"<<endl; 
                        ent
                        showAdminMenu();
                    }else{
